...
CONCAT(SUBSTRING(LPAD(CAST(dateofbirth AS VARCHAR), 8, '0'), 1, 4),
       '-', 
       SUBSTRING(LPAD(CAST(dateofbirth AS VARCHAR), 8, '0'), 5, 2),
       '-', 
       SUBSTRING(LPAD(CAST(dateofbirth AS VARCHAR), 8, '0'), 7, 2)) AS nhs_dob,

SUBSTRING(LPAD(CAST(dateofbirth AS VARCHAR), 8, '0'), 1, 4) AS nhs_dob_year,

SUBSTRING(LPAD(CAST(dateofbirth AS VARCHAR), 8, '0'), 5, 2) AS nhs_dob_month,

SUBSTRING(LPAD(CAST(dateofbirth AS VARCHAR), 8, '0'), 7, 2) AS nhs_dob_day,
